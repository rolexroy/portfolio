...
export const aboutData = {
  ...
  resume: 'https://ecstatic-easley-f2b50b.netlify.app/', // if no resume, the button will not show up
};
...
export const projectsData = [
  ...
  },
  {
    ...
    url: '',
    repo: 'https://ecstatic-easley-f2b50b.netlify.app/', // if no repo, the button will not show up
  },
  {
    id: nanoid(),
    img: 'listapp.jpg',
  ...
  networks: [
    {
      id: nanoid(),
      name: 'twitter',
      url: 'https://ecstatic-easley-f2b50b.netlify.app',
    },
    // {
    //   id: nanoid(),
    //   name: 'codepen',
